...
import com.genug.aop.member.annotation.ClassAop;
import com.genug.aop.member.annotation.MethodAop;
...
public class ParameterTest {
    ...
    static class ParameterAspect {
        @Pointcut("execution(* com.genug.aop.member..*.*(..))")
        ...
        public void atWithingetArgs(JoinPoint joinPoint, ClassAop annotation) {
